...
public class Consumption {
	...
	public String toString() {
		return "Consumption [ID=" + ID + ", FISCAL_QUATER=" + FISCAL_QUATER + ", FISCAL_WEEK_IN_QUATER="
				+ FISCAL_WEEK_IN_QUATER + ", FISCAL_MONTH_IN_QUATER=" + FISCAL_MONTH_IN_QUATER + ", CONTRACT_TYPE="
				+ CONTRACT_TYPE + ", METEREDLOB=" + METEREDLOB + ", CHILD_TIER=" + CHILD_TIER + ", TRUE_USAGE="
				+ TRUE_USAGE + ", CONTRACT_TYPE_TARGET=" + CONTRACT_TYPE_TARGET + ", OVERALL_USAGE_TARGET="
				+ OVERALL_USAGE_TARGET + ", LOBTARGET=" + LOBTARGET + ", UPDATED_DATE=" + UPDATED_DATE + "]";
	}
